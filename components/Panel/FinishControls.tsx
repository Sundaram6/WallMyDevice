...
export function FinishControls() {
  ...
  return (
    <div className="space-y-3">
      <label className="flex items-center justify-between text-xs text-[#2B2A26]">
      ...
      <label className="block">
        <div className="mb-1 flex items-center justify-between text-xs text-[#2B2A26]">
          ...
          <span className="tabular-nums font-mono text-[11px] text-[#8A8579]">{grainIntensity.toFixed(2)}</span>
        </div>
      ...
      <label className="block">
        <div className="mb-1 flex items-center justify-between text-xs text-[#2B2A26]">
          ...
          <span className="tabular-nums font-mono text-[11px] text-[#8A8579]">{blurIntensity.toFixed(2)}</span>
        </div>
