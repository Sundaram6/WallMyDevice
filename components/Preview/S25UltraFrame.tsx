...
export function S25UltraFrame({ children }: Props) {
  return (
    <div className="relative group flex items-center justify-center">
      {/* Volumetric Underglow */}
      <div className="absolute -inset-4 bg-gradient-to-tr from-brand-accent/20 via-blue-900/10 to-emerald-900/10 rounded-[2.2rem] blur-2xl opacity-60 group-hover:opacity-80 transition-opacity pointer-events-none" />

      {/* S25 Ultra Chassis Container (Titanium Chamfer & Sharp 14px Screen Curve) */}
      <div className="relative rounded-[1.6rem] p-[3px] bg-gradient-to-b from-[#43454A] via-[#1D1E22] to-[#121316] shadow-[0_25px_60px_-15px_rgba(0,0,0,0.8),0_0_2px_1px_rgba(255,255,255,0.12)]">
        {/* Outer Titanium Bezel & Antenna Lines */}
        <div className="relative rounded-[1.5rem] p-[8px] bg-[#16171A] ring-1 ring-white/10 shadow-inner overflow-hidden flex flex-col justify-between">
          {/* Side Antenna Lines */}
          ...
          {/* Screen Container */}
          <div className="relative rounded-[1.2rem] bg-black overflow-hidden shadow-2xl ring-1 ring-black/80">
            {children}
            ...
            <div className="pointer-events-none absolute inset-0 z-20 rounded-[1.2rem] ring-1 ring-inset ring-white/10" />
          </div>
        </div>
      </div>
    </div>
