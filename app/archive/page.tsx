  ...
  return (
    <div className="min-h-screen bg-paper-50 text-ink-900 font-sans">
      ...
      <main className="mx-auto max-w-7xl px-6 py-10">
        {/* Header */}
        <div className="mb-8">
          <h1 className="font-serif text-3xl font-medium text-ink-900">The Archive</h1>
          <p className="mt-2 text-sm text-ink-700">
            Browse our historical archive of past recipes and themed collections. Open any collection to view its prints and remix them in the Studio.
          </p>
        </div>
